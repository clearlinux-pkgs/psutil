...
Version  : 5.4.0
Release  : 39
URL      : http://pypi.debian.net/psutil/psutil-5.4.0.tar.gz
Source0  : http://pypi.debian.net/psutil/psutil-5.4.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1509377529
