...
%prep
%setup -q -n psutil-5.7.3
cd %{_builddir}/psutil-5.7.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1603727377
...
cp %{_builddir}/psutil-5.7.3/LICENSE %{buildroot}/usr/share/package-licenses/psutil/51ede753f5d20b28226ab01c133ad67797eaf716
